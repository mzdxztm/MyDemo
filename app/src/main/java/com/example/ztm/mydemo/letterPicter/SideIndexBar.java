package com.example.ztm.mydemo.letterPicter;
...
public class SideIndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.SideIndexBar, defStyleAttr, 0);
        mTextSize = (int) typedArray.getDimension(R.styleable.SideIndexBar_cpIndexBarTextSize, 14);
        mTextColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarNormalTextColor,
                context.getResources().getColor(R.color.colorPrimary));
        mTextTouchedColor = typedArray.getColor(R.styleable.SideIndexBar_cpIndexBarSelectedTextColor,
