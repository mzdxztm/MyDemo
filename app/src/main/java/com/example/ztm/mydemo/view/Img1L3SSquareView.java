...
public class Img1L3SSquareView extends LinearLayout {
    ...
    public Img1L3SSquareView(Context context) {
        this(context, null);
    }

    public Img1L3SSquareView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Img1L3SSquareView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView(Context context) {
        ...
        iv4 = getImageView234();
        addView(iv1);
        linearLayout = init234ImgLayout();
        linearLayout.addView(iv2);
        linearLayout.addView(iv3);
        linearLayout.addView(iv4);
        addView(linearLayout);
        setImgMargin(10, 10);
    }

    private LinearLayout init234ImgLayout() {
        LinearLayout linearLayout = new LinearLayout(getContext());
        LayoutParams params = new LayoutParams(0, screenWidth / 4 * 3);
        params.weight = 1;
    ...
    private ImageView getImageView234() {
        ImageView iv = new ImageView(getContext());
    ...
    public void setImgMargin(int innerMargin, int outerMargin) {
        ...
        layoutParams3.setMargins(innerMargin, 0, outerMargin, innerMargin);
