...
public class Img1L2SView extends LinearLayout {
    ...
    public Img1L2SView(Context context) {
        this(context, null);
    }

    public Img1L2SView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Img1L2SView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
